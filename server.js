...
import staffKeyCardRoutes from './routes/staffKeyCards.js';
...
import { startAutoCheckoutScheduler, stopAutoCheckoutScheduler } from './jobs/autoCheckoutScheduler.js';
import { startPaymentPendingBookingScheduler, stopPaymentPendingBookingScheduler } from './jobs/paymentPendingBookingScheduler.js';
...
const allowedOrigins = [
  ...
  'https://finpowergloballimited.com',
];
...
app.use('/api/staff-key-cards', staffKeyCardRoutes);
...
startPaymentPendingBookingScheduler();
...
process.on('SIGINT', async () => {
  ...
  stopPaymentPendingBookingScheduler();
  await disconnectDB();
  server.close(() => {
