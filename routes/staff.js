...
router.get('/hotel/:hotelId/assignable', protect, staffController.getAssignableStaff);
...
router.get('/hotel/:hotelId/schedules', protect, staffController.getHotelSchedules);
